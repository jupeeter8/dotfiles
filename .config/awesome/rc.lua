...
local rofi         = "/home/ani/.config/rofi/launchers/type-6/launcher.sh"
...
globalkeys = mytable.join(
    ...
    awful.key({modkey, altkey}, "Up", function () os.execute("ddcutil setvcp 10 + 20") end,
              {description = "Brightnes +10%", group = "hotkeys"}),
    awful.key({modkey, altkey}, "Down", function () os.execute("ddcutil setvcp 10 - 20") end,
              {description = "Brightnes -10%", group = "hotkeys"}),
